...
export default function AdminActivities() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const url = formData.id ? `/api/admin/activities/${formData.id}` : "/api/admin/activities";
  ...
  return (
    <div>
      ...
      {isEditing && (
        <div className="card">
          <h2>{formData.id ? "Edit" : "Add"} Activity</h2>
          <form onSubmit={handleSubmit}>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
              ...
              <div className="form-group" style={{ gridColumn: "span 2" }}>
                ...
                <input value={formData.duration} onChange={e => setFormData({ ...formData, duration: e.target.value })} placeholder="e.g. 2 Hours, All Day..." />
              </div>
            </div>
            <div className="form-group">
