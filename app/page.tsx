...
function SocialIcon({ kind }: { kind: "instagram" | "facebook" | "tiktok" | "vk" }) {
  ...
  return (
    <svg {...common}>
      <path d="M4 7h2.4c.2 0 .4.1.5.3l1.7 4.3c.2.6 1 .7 1.4.2l2.3-2.8c.2-.3.3-.6.3-1V7h2.3v.6c0 .8-.3 1.6-.8 2.2l-2.1 2.6c-.3.4-.2.9.1 1.2l2.6 3c.4.5 1 .3 1.2-.3l1.2-3.5c.1-.2.3-.4.5-.4H20l-1.9 5.5c-.3.9-1.5 1.3-2.2.6l-3.1-3.6c-.3-.4-.9-.4-1.2 0l-1.3 1.6c-.8 1-2.4.7-2.9-.5L4 7z" />
    </svg>
  );
}
